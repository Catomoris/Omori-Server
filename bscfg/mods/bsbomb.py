...
class NewBomb(Bomb):
    ...
    def __init__(self,
        ...
        # def update_text():
        #     if self._powText.exists() and self.node.exists():
        #         self._powText.text = random_phrase()
        #     else:
        #         self._phrasetimer = None

        # self._phrasetimer=bs.Timer(50, bs.Call(update_text), repeat=True)
